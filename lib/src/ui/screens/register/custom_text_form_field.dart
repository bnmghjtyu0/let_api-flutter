...
class CustomTextFormField extends FormField<String> {
  ...
  CustomTextFormField({
    ...
    TextAlign errorTextAlign = TextAlign.end,
              ...
              children: [
                TextField(
                  ...
                  style: state.hasError
                      ? style?.copyWith(color: $styles.colors.red) ??
                          TextStyle(color: $styles.colors.red)
                      : style,
                  strutStyle: strutStyle,
                  textAlign: textAlign,
                  textAlignVertical: textAlignVertical,
                ...
                if (errorText != null && errorText.isNotEmpty) ...[
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: 14, color: $styles.colors.red),
                  ),
                ],
              ],
            );
